...
export const mainnetTokens = {
  wvlx: new Token(MAINNET, addresses[1116].WVLX, 18, 'WVLX', 'Wrapped VLX', 'https://wagyuswap.app/'),
  ...
  vlx: new Token(MAINNET, addresses[1116].WVLX, 18, 'VLX', 'VLX', 'https://wagyuswap.app/'),
  cake: new Token(MAINNET, addresses[1116].WAGToken, 18, 'WAG', 'WAGToken', 'https://wagyuswap.app/'),
  usdt: new Token(
    MAINNET,
  ...
  syrup: new Token(TESTNET, addresses[1116].WAGStake, 18, 'WAGStake', 'WAGStake Token', 'https://wagyuswap.app/'),
  // te6: new Token(TESTNET, addresses[1115].TE6, 6, 'TE6', 'ERC20 Token', 'https://wagyuswap.app/'),
  // te9: new Token(TESTNET, addresses[1115].TE9, 9, 'TE9', 'ERC20 Token', 'https://wagyuswap.app/'),
  // te12: new Token(TESTNET, addresses[1115].TE12, 12, 'TE12', 'ERC20 Token', 'https://wagyuswap.app/'),
  // te18: new Token(TESTNET, addresses[1115].TE18, 18, 'TE18', 'ERC20 Token', 'https://wagyuswap.app/'),
}

export const testnetTokens = {
  wvlx: new Token(TESTNET, addresses[1115].WVLX, 18, 'WVLX', 'Wrapped VLX', 'https://wagyuswap.app/'),
  cake: new Token(TESTNET, addresses[1115].WAGToken, 18, 'WAG', 'WAGToken', 'https://wagyuswap.app/'),
  syrup: new Token(TESTNET, addresses[1115].WAGStake, 18, 'WAGStake', 'WAGStake Token', 'https://wagyuswap.app/'),
  usdt: new Token(
    TESTNET,
